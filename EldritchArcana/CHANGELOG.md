...
### Changed
- Game version to 2.1.7b

### Fixed
- Spell replacement for spontaneous casters Loading spellbooks now will not fail becouse of other mods that add their own spellbook system such as 'C.O.T.W'. 
