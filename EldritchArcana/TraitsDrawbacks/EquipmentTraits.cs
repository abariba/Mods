...
namespace EldritchArcana
{
    internal class EquipmentTraits
    {
        public static BlueprintFeatureSelection CreateEquipmentTraits()
        {
            ...
            //134
            //.
            var Quarterstaff = Traits.library.Get<BlueprintWeaponType>("629736dabac7f9f4a819dc854eaed2d6");
            var QuarterstaffPlus1 = Traits.library.Get<BlueprintItem>("2c4a3077efc2378499c60b03d2b0527a");
            ...
            var HeirloomWeapontypesguidfeaturelist = new string[]
            {
                ...
                "54e960775daa4714fa52e0954d8cf862",//EarthBreaker.
                "b5e6838ad2a62b146b49619bcf9f42aa",//ElvenCurvedBlade.

                "1af5621e2ae551e42bd1dd6744d98639",//Falcata.
                "8fefb7e0da38b06408f185e29372c703",//HeavyFlail.
            ...
            var HeirloomWeaponguidfeaturelist = new string[]
            {
                ...
                "23855f41005569b43bcdca1c299471b4",//EarthBreaker.//ColdIronEarthBreakerPlus1.
                "158fbe1c26025f3459c1af29a8faf2d8",//ElvenCurvedBlade.//ElvenCurvedBladePlus1.
            ...
            var HeirloomWeapons = new List<BlueprintFeature>()
            {
                ...
                //compshortbow
                Helpers.CreateFeature("HairloomTraitQuarterstaff", "Family Heirloom Quarterstaff",
                "You are from a family of competent monks and you leave the house with a family made quarterstaff." +
                "\nBenefit: If you are using a quarterstaff you gain +1 on attack rols.",
                HeirloomWeaponGuidlist[6],
                QuarterstaffPlus1.Icon,
                FeatureGroup.None,Helpers.Create<AddStartingEquipment>(a =>
                {
                    a.CategoryItems = Array.Empty<WeaponCategory>();
                    a.RestrictedByClass = Array.Empty<BlueprintCharacterClass>();
                    a.BasicItems = new BlueprintItem[] { QuarterstaffPlus1 };
                }),
                Helpers.Create<WeaponAttackAndCombatManeuverBonus>(a => { a.WeaponType = Quarterstaff; a.AttackBonus = 1; a.Descriptor = ModifierDescriptor.Trait;})
                ),
                //compshortbow
